...
if(WIN32)
    ...
    execute_process(COMMAND powershell -ExecutionPolicy Bypass -File "resolve_symlinks.ps1" "${cargokit_cmake_root}" OUTPUT_VARIABLE cargokit_cmake_root OUTPUT_STRIP_TRAILING_WHITESPACE)
endif()
